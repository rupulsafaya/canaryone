...
if (cli.flags.start) {
  const valid = ['keySetup', 'apiKeys', 'onboarding', 'summarizeTasks', 'methodologyCheck', 'pickTasks', 'taskDetail', 'pickRoutes', 'pickModels', 'pickDestinations', 'confirm', 'liveProgress'] as const;
